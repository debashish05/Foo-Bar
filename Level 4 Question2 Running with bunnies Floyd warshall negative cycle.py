"""Floyd warshall is used to find all pair shortest path and negative cycle in graph"""
...
def solution(times, times_limit):
    ...
    power_set_size=2**(len(times)-2) # total no of combinatios of bunny that can be picked
